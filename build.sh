...
pacstrap -c -K $WORKDIR \
  base base-devel iwd eza gptfdisk linux-hardened linux-firmware-intel intel-ucode iptables ntpd-rs dnscrypt-proxy apparmor chromium tpm2-tss tpm2-tools erofs-utils \
  ...
  sway kanshi xdg-desktop-portal-wlr waybar mako swayidle swaylock swaybg fuzzel yazi tmux adobe-source-code-pro-fonts ttf-jetbrains-mono otf-font-awesome
