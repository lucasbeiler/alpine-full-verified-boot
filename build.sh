...
pacstrap -c -K $WORKDIR \
  ...
  mkinitcpio openssh pamixer fastfetch git unzip unrar pipewire-jack power-profiles-daemon python-gobject sof-firmware wireplumber pipewire-pulse pavucontrol \
  ...
  sway kanshi xdg-desktop-portal-wlr swayidle swaylock swaybg fuzzel yazi tmux \
